 ...
 * methods.
 */
final class SimpleChessAI extends AbstractEngine implements Protocol {
   ...
   */
  public SimpleChessAI(BufferedReader input, PrintStream output) {
    super(input, output);
  }
   ...
   */
  public SimpleChessAI(IProtocolHandler handler) {
    super(handler);
  }
